...
//        label.text = "Something"
        ...
        attributedText.append(NSAttributedString(string: " Some caption text that will wrap on the next line or not depending on the legth", attributes: [NSAttributedString.Key.font : UIFont.systemFont(ofSize: 14)]))
